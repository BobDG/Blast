Pod::Spec.new do |s|
  s.name           	= "Blast"
  s.version        	= "0.0.1"
  s.summary        	= "High-performance Swift framework to accelerate iOS app development with UITableViewControllers for every view"
  s.license 	    	= "MIT"
  ...
  s.resources 		= ["Blast/**/*.{xib}", "Blast/**/*.{png}"]
  s.platform       	= :ios, "14.0"
  s.requires_arc   	= true
  s.module_name 	= "Blast"
end
